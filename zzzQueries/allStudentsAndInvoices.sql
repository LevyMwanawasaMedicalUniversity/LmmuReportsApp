SELECT
    ...
    END as "2023 Invoice",
    CASE 
        WHEN bi.ID LIKE "230%" then 0
        WHEN bi.ID LIKE "220%" then program.YEAR1 
    	WHEN bi.ID LIKE "210%" then program.YEAR1 + program.YEAR2
    	WHEN bi.ID LIKE "190%" then program.YEAR1 + (program.YEAR2 * 2)
    END as "Total Previous Invoice",
    CASE 
        WHEN bi.ID LIKE "230%" then program.YEAR1
