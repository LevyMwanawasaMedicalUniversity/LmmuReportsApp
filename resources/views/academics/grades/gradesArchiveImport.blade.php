@extends('layouts.app', [
    'class' => 'sidebar-mini ',
    'namePage' => 'Import Grades Archive',
    'activePage' => 'importGradesArchive',
    'activeNav' => '',
])
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Import Students to Archive</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('academics.UploadradesToArchive') }}" method="POST" enctype="multipart/form-data">
                        @csrf
