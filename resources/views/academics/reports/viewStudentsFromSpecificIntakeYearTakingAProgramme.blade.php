        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Students From Specific Intake Year Taking A Programme</h4>
                </div>
                        ...
                        <div class="col-md-3 ml-3">
                            <div class="form-group">
                                ...
                                <select name="intakeName" id="intakeName" class="form-control">
                                    ...
                                    <option value="250" @if (isset($intakeName) && $intakeName == '250') selected @endif>250 (2025)</option>
                                </select>
                            </div>
                        </div>
