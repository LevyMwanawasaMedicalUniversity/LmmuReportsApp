        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Registered Students From Specific Intake Year Taking A Programme</h4>
                </div>
                <form action="{{ route('viewRegisteredStudentsFromSpecificIntakeYearTakingAProgramme') }}" method="GET">
                    <div class="row">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="btn btn-success float-right mt-3 mr-2" href="{{ route('exportRegisteredStudentsFromSpecificIntakeYearTakingAProgramme',['intakeName' => $intakeName, 'programmeName' => $programmeName]) }}">Export Data</a>
                            @endif
                        </div>
                    </div>
                </form>
