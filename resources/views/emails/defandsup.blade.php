    ...
    <div style="font-family: Arial, sans-serif; font-size: 16px; margin: 20px;">
        {{-- <b>
            <b> --}}
                ...
                <p><strong>Starting now, please use your personal email '{{ $studentDetails->PrivateEmail }}' as your username and '12345678' as your password for login. If you encounter any challenges logging in, utilize the "Forgot Password" option located just below the login section. Enter '{{ $studentDetails->PrivateEmail }}' as the email address and follow the provided instructions.</strong></p>
