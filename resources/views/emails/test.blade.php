    ...
    <div style="font-family: Arial, sans-serif; font-size: 16px; margin: 20px;">
        <b>
            <b>
                ...
                <p>You can log in to the system using your student number as the username (e.g., 123456789@lmmu.ac.zm) and your National Registration Card (NRC) number as the password.</p>
